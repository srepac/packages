...
Requirements:   
  ...
  - Pi4 KVM with USB dongle and power/data splitter (Pibuntu)
...
1.  Install ubuntu on Rpi4.  Login and become root.  Install python3, extract tar files from NFS mount into /, and move kvmd python scripts to the correct location for ubuntu.
...
**NOTE:  BEFORE Starting kvmd service, you need to comment out line 81 in /usr/lib/python3.9/site-packages/kvmd/plugins/ugpio/gpio.py**
